...
class HealthResponse(BaseModel):
    ...
    primary_provider: str | None = Field(None, description="Clean primary LLM provider name, e.g. 'gemini'")
    primary_model: str | None = Field(None, description="Clean primary LLM model name, e.g. 'gemini-flash-latest'")
    fallback_provider: str | None = Field(None, description="Clean fallback LLM provider name, e.g. 'groq'")
    fallback_model: str | None = Field(None, description="Clean fallback LLM model name, e.g. 'openai/gpt-oss-120b'")
